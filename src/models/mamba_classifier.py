...
class MambaClassifier(nn.Module):
    ...
    def __init__(
        ...
        # NOTE: Removed extra layer norms and residual logic here to match MambaRegressor and standard practice.
        # MambaBlock already handles normalization and residuals internally.
    ...
    def forward(self, x: torch.Tensor, asset_ids: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        for mamba_layer in self.mamba_layers:
            # Simplified forward pass to match MambaRegressor
            x = mamba_layer(x)
